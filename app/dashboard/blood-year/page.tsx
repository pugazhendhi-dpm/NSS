...
import { Droplet, Plus, Trash2, ChevronDown, ChevronUp, CalendarDays, Users, HeartPulse, FlaskConical } from 'lucide-react'
import {
...
export default function BloodDonationYearPage() {
    ...
    const [records, setRecords] = useState<BloodDonationYearRecord[]>([])
    ...
    useEffect(() => {
        ...
        setVolunteer(vol)
        if (!hasPermission(vol.role, 'VIEW_CAMPAIGNS')) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!volunteer) return
        setSubmitting(true)
        const success = await addBloodDonationYearRecord({
        ...
        if (success) {
            ...
            setFormData({ academicYear: '', eventName: '', donationDate: '', unitsDonated: '', donorsCount: '' })
            setShowForm(false)
            await loadRecords()
        }
        setSubmitting(false)
    ...
    const totalUnitsAllTime = yearSummaries.reduce((s, y) => s + y.totalUnits, 0)
    const totalDonorsAllTime = yearSummaries.reduce((s, y) => s + y.totalDonors, 0)
    const totalEventsAllTime = yearSummaries.reduce((s, y) => s + y.totalEvents, 0)
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-3">
                            {hasPermission(volunteer?.role, 'MANAGE_CAMPAIGNS') && (
                                <button
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white rounded-xl shadow-md p-6 border-t-4 border-red-500 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-bold text-red-600">{totalUnitsAllTime}</p>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 border-t-4 border-blue-500 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-bold text-blue-600">{totalDonorsAllTime}</p>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 border-t-4 border-green-500 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-bold text-green-600">{totalUnitsAllTime * 3}</p>
                ...
                {/* Add Record Form */}
                {showForm && hasPermission(volunteer?.role, 'MANAGE_CAMPAIGNS') && (
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={e => setFormData({ ...formData, unitsDonated: e.target.value })}
                                    className="input-field"
                                />
                            </div>
                            <div>
                            ...
                            <div className="flex items-end">
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2.5 px-6 rounded-lg transition-colors disabled:opacity-50"
                                >
                                        ...
                                        <table className="w-full text-sm">
                                            ...
                                            <tbody>
                                                ...
                                                <tr className="bg-red-50 border-t-2 border-red-200 font-bold">
                                                    ...
                                                    {hasPermission(volunteer?.role, 'MANAGE_CAMPAIGNS') && <td></td>}
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
